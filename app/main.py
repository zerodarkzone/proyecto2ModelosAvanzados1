...
def home_view():
    return "<h3>Request de Ejemplo:</h3><a>https://proyecto2-modelosa-vanzados1.herokuapp.com/predict?year=2014&mileage=31909&state=md&make=nissan&model=muranoawd</a>"
